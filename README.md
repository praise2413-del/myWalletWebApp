...
See [docs/ui-design.md](docs/ui-design.md) for the design system, [docs/architecture.md](docs/architecture.md) for project structure, [docs/database.md](docs/database.md) for the schema, [docs/insights.md](docs/insights.md) for the insights engine, [docs/reports.md](docs/reports.md) for reporting/period logic, [docs/security.md](docs/security.md) for the threat model, and [docs/testing.md](docs/testing.md) for how the app is verified. `docs/deployment.md` is added once Phase 11 lands.
